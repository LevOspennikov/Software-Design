...
<!-- span style="float:left;"-->
    ...
    <h3>Add to todo-list ${todo_list.getName()}</h3>
    ...
    <form:form modelAttribute="todo_list" method="GET" action="/get-todo_list">
        <table>
            <tr>
                ...
                <td><input type="submit" value="ok" onclick="form.action='/get-todo_list';"></td>
                <td><input type="submit" value="remove" onclick="form.action='/delete-todo_list';"></td>
            </tr>
        </table>
    </form:form>
